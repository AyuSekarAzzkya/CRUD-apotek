        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav">
                    @if (Auth::check())
                        <li class="nav-item">
                            <a class="nav-link {{ request()->is('home') ? 'active' : '' }}" href="{{ route('home.page') }}">Dashboard</a>
                        </li>
                        <li class="nav-item">
                        ...
                        @if (Auth::user()->role == 'kasir')
                            <li class="nav-item">
                                <a href="{{ route('pembelian') }}" class="nav-link {{ request()->is('pembelian') ? 'active' : '' }}">Pembelian</a>
                            </li>
                        @endif
                        ...
                        @if (Auth::user()->role == 'admin')
                            <li class="nav-item">
                                <a class="nav-link {{ request()->is('user') ? 'active' : '' }}" href="{{ route('user.index') }}">Kelola Akun</a>
                            </li>
                        @endif
                    @endif
                </ul>
